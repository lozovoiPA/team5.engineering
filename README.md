...
Пользователь может сортировать встречи - отобразить ближайшие, на день, на неделю или важные - выбрав соответствующий пункт в выпадающем меню на верхней панели.
### Создание встреч
...
Для создания встречи автоматически приложение должно быть запущено (открыто главное окно), пользователь выделяет некоторый текст и нажимает комбинацию клавиш Alt+Shift+Z.
...
Примечание: скриншоты выше были созданы 28.03.2026)

### Запуск приложения
Для запуска подготовлен релиз. Необходимо скачать архив smartmeet.rar, после чего запустить main.exe. 
