...
class UiWorker:
    ...
    def show_meeting_window_with_prefill(self, meeting):
        MeetingWindow(self.main_window, on_save=self.main_window._on_meeting_created, prefill_meeting=meeting)

    def show_meeting_window(self):
        MeetingWindow(self.main_window, on_save=self.main_window._on_meeting_created)